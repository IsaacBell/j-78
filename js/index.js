var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var World = function () {
  function World(width, height) {_classCallCheck(this, World);
    ...
    this.targetRotY1 = -0.2;
    this.targetRotY2 = 0.2;
    ...
    this.createPlanes();
    this.render();
  }_createClass(World, [{ key: 'createPlanes', value: function createPlanes()

    {
      ...
      this.shape.rotation.x = Math.PI * 1.7;

      this.shape2 = new THREE.Mesh(this.shapeGeometry, this.material2);
      this.shape2.position.y = -25;
      this.shape2.rotation.x = -Math.PI * 3.5;
...

    {
      ...
      this.shape2.rotation.x += (this.targetRotX2 - this.shape2.rotation.x) * .00;

      this.shape.rotation.y += (this.targetRotY1 - this.shape.rotation.y) * .85;
      this.shape.rotation.x += (this.targetRotX1 - this.shape.rotation.x) * .85;
